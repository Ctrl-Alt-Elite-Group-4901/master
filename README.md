...
upload of updated game and UI
needs to add password authentication + continue project development by merging to the main branch - this branch is for storage and clarity right now

TODO:
add password hashing
create single .exe file version
