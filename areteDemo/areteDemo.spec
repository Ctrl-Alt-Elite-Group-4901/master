...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'areteDemo.auth',
        'areteDemo.run_data',
        'areteDemo.reflection_questions',
        'areteDemo.screens',
        ...
        'areteDemo.screens.editor_menu',
        'areteDemo.screens.editor_page',
        'areteDemo.screens.memory_question_editor',
        'areteDemo.screens.player_directory',
        'areteDemo.screens.player_runs',
        'areteDemo.screens.ui_helpers',
